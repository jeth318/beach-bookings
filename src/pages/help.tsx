      ...
      <MainContainer>
        ...
        >
          ...
          <div className="flex flex-col ">
            ...
            <a
              className="link mt-4 text-xl"
              href="mailto:admin@beachbookings.se"
            >
          ...
          <p className="pl-6 text-lg font-normal text-gray-500 dark:text-gray-400 lg:text-xl">
            Log in and tap the green Join-button (if visible). After
            confirmation, an email will be sent to the other players in the
            booking letting them know about the new recruit.
          </p>
          <br />
          <hr />
          <br />
          ...
          <p className="pl-1 text-lg font-normal text-gray-500 dark:text-gray-400 lg:text-xl">
            ...
            only for bookings added by you). After confirmation, an email will
            be sent to the other players in the booking with information of the
            update.
          </p>
          <br />
          <hr />
